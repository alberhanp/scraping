class ScrapingSoup:
    def __init__(self, soup):
        super().__init__()
        self.mkt_channels_distribution = None
    ...
    def get_mkt_channels_distribution(self):
        percentages = self.soup.find_all('tspan', class_='wa-traffic-sources__channels-data-label')

        percent_values = [percentage.text for percentage in percentages]

        self.mkt_channels_distribution = percent_values
